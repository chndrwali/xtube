      ...
      <MuxUploaderDrop muxUploader={UPLOADER_ID} className="group/drop ">
        <div slot="heading" className="flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col gap-2 text-center">
            <p className="text-sm">Seret dan jatuhkan file video untuk diunggah</p>
            <p className="text-xs text-muted-foreground">Video Anda akan diprivasi sampai Anda menerbitkannya</p>
          </div>
